...
export const topicIndexSections: IndexSection[] = [
  {
    ...
    topics: [
      // What AI is — foundation (how it works)
      {
        name: 'How LLMs "understand" code',
        problem: "Enough internals to build intuition without the math.",
      },
      {
        name: "Understanding AI hallucinations in code",
        problem: "What breaks, why, and how to catch it.",
      },
      {
        name: "Model differences",
        problem: "When to use which model; speed vs quality vs cost.",
      },
      {
        name: "Tokenization & Non-English language",
        problem:
          "How tokens affect Mongolian and other non-English languages; cost and context.",
      },
      // How to use AI — prompting
      {
        name: "Prompting fundamentals",
        problem: "Zero-shot vs few-shot, context windows, system prompts.",
      },
      // Mindset — working with AI
      {
      ...
      // Process & product — specs, PM (SDD includes Speckit, Augment intent)
      {
        name: "SDD (Speckit, Augment intent)",
        problem:
          "Specification-driven development; specs as source of truth. Speckit for tooling and structured requirements; Augment intent for clarifying and refining user intent before calling the model.",
      },
      {
      ...
      // Techniques & tools — RAG, fine-tuning, wrappers, Cursor
      {
        name: "RAG",
        problem:
  ...
  },
  {
    ...
    topics: [
      {
        name: "IDE modernization",
        problem: "Cursor, VS Code + Copilot, AI-assisted editors.",
      },
      {
        name: "Git basics to Git best practices",
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        problem: "Pipelines in your ecosystem (e.g. Azure DevOps, GitLab CI).",
      },
      {
  ...
  },
  {
    ...
    topics: [
      ...
      {
        name: "TDD lite",
        problem: "Writing tests before AI-generated code, not religious TDD.",
      },
      {
    ...
    topics: [
      {
        ...
        problem: "Queues, async processing, DLQ for failed or poison messages.",
      },
      {
        name: "Idempotency",
        problem:
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        problem: "Query optimization, index suggestions, migration scripts.",
      },
      {
